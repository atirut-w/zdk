...
enum TokenKind {
    ...
    T_CHAR, T_SHORT, T_INT, T_LONG, T_SIGNED, T_UNSIGNED,
    T_FLOAT, T_DOUBLE, T_CONST, T_VOLATILE, T_VOID,
    T_STRUCT, T_UNION, T_ENUM, T_ELLIPSIS,
    T_CASE, T_DEFAULT, T_IF, T_ELSE, T_SWITCH, T_WHILE, T_DO,
    T_FOR, T_GOTO, T_CONTINUE, T_BREAK, T_RETURN,
