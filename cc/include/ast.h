...
struct ASTNode;
struct ASTList { struct ASTNode *node; struct ASTList *next; };
...
struct ASTNode *ast_new_stmt_if(struct ASTNode *cond, struct ASTNode *then_s, struct ASTNode *else_s, int line, int col);
struct ASTNode *ast_new_stmt_while(struct ASTNode *cond, struct ASTNode *body, int line, int col);
struct ASTNode *ast_new_stmt_dowhile(struct ASTNode *body, struct ASTNode *cond, int line, int col);
struct ASTNode *ast_new_stmt_for(struct ASTNode *init, struct ASTNode *cond, struct ASTNode *step, struct ASTNode *body, int line, int col);
...
struct ASTNode *ast_new_stmt_switch(struct ASTNode *cond, struct ASTNode *body, int line, int col);
struct ASTNode *ast_new_stmt_goto(const char *label, int line, int col);
struct ASTNode *ast_new_stmt_label(const char *label, struct ASTNode *stmt, int line, int col);
struct ASTNode *ast_new_stmt_case(struct ASTNode *expr, struct ASTNode *stmt, int line, int col);
...
struct ASTNode *ast_new_decl(int spec_flags, struct Declarator *decltor, struct ASTNode *init, int line, int col);
struct ASTNode *ast_new_external(struct ASTNode *decl, struct ASTNode *body, int line, int col);
